...
class AIMessageEditError(AppException):
    """
    Raised when a user attempts to edit a message that was generated by the AI.
    """

    status_code = 403  # Forbidden
    error_code = ErrorCode.AI_MESSAGE_EDIT_NOT_ALLOWED
    message = "Editing messages generated by the AI tutor is not permitted."
