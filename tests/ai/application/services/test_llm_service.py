...
from src.ai.application.services import LLMService
...
def test_get_llm_loads_model_on_first_call_and_caches(
    ...
    mock_llama_class = mocker.patch("src.ai.application.services.llm_service.LlamaCpp")
    ...
    mocker.patch(
        "src.ai.application.services.llm_service.PROJECT_ROOT",
        mock_path,
    )
